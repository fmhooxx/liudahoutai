    ...
    routes: [{
        ...
        },
        {
            ...
            children: [{
                    ...
                    path: '/TodayNumber',
                    component: () => import( /* webpackChunkName: "dashboard" */ '../components/page/Today/TodayNumber.vue'),
                    meta: {
                        title: '今日人数'
                    }
                }, {
                    path: '/TodayProfit',
                    component: () => import( /* webpackChunkName: "dashboard" */ '../components/page/Today/TodayProfit.vue'),
                    meta: {
                        title: '今日收益'
                    }
                }, {
